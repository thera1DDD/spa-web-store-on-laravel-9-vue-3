            ...
            <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
              <div class="single-product-box one">
                <div class="big-product single-product-one slider-for">
                  <div>
                    <div class="single-item"> <img :src="products.image_url" alt="">
              ...
              <div class="shop-details-top-right ">
                <div class="shop-details-top-right-content-box">
                  ...
                  <div class="shop-details-top-price-box">
                    <h3>{{products.price}}R <del>{{products.old_price}}R</del></h3>
                  </div>
                  ...
                  <div class="shop-details-top-order-now"> <i class="flaticon-point"></i>
                    <p>Осталось {{products.count}} шт.</p>
                  </div>
                  <div class="shop-details-top-cart-box-btn"> <button  @click.prevent="addToCart(products.id,products.title,products.image_url,products.price,products.subtotal)" class="btn--primary style2 "
...
data(){
  ...
  methods:{
      addToCart(id,title,image_url,price,subtotal){
    ...
    getProduct(id){
      this.axios.get(`/api/intercom/${this.$route.params.id}`)
          .then(res=>{
