<template>
  <main class="overflow-hidden">
    ...
    <section class="breadcrumb-area" style="background-image: url(/asshets/images/inner-pages/breadcum-bg.png);">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
              ...
              <div class="wishlist-table-outer">
                <table class="wishlist-table">
                  ...
                  <tr v-for="product in products"  >
                    <td>
                      <div class="wishlist-thumb"><router-link :to="{name: 'products.show',params:{id:product.id}}"><img
                          :src="product.image_url" alt=""></router-link>  </div>
                    </td>
                    <td>
                    ...
                    <td >
                      <p v-if="product.count!==0"  class="instock">В наличии</p>
                      <p v-else="product.count==0"   class="notinstock">Нет в наличии</p>
                    </td>
                    <td>
          ...
          <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 mt-30 wow fadeInUp animated">
            <div class="footer-default__single-box">
              <div class="company-info">
                <div class="footer-logo"> <a href="index.html"> <img src="src/assets/images/logo/logo-2.png"
                                                                     alt=""> </a> </div>
                <div class="text1">
      ...
      <div class="container">
        <div class="footer_bottom_content">
          ...
          <div class="footer-payment wow fadeInUp animated"> <a href="#0"> <img
              src="src/assets/images/payment_method/payment_1.png" alt="payment"> </a> <a href="#0"> <img
              src="src/assets/images/payment_method/payment_2.png" alt="payment"> </a> <a href="#0"> <img
              src="src/assets/images/payment_method/payment_3.png" alt="payment"> </a> <a href="#0"> <img
              src="src/assets/images/payment_method/payment_4.png" alt="payment"> </a> </div>
