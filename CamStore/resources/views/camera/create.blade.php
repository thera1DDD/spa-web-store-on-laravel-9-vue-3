...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Добавить Камеру</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <form action="{{route('camera.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input name="camera_images[]" type="file" class="custom-file-input" id="exampleInputFile">
                                <label class="custom-file-label" for="exampleInputFile">Выберите файл</label>
                            </div>
                            <div class="input-group-append">
                                <span class="input-group-text">Загрузка</span>
                    ...
                    <div class="form-group">
                        <select name="megapixel_id" class="form-control select2" data-placeholder="Выберите мегапиксели" style="width: 100%;">
                            @foreach($megapixels as $megapixel)
                                <option value="{{$megapixel->id}}">{{$megapixel->title}}</option>
                            @endforeach()
                        </select>
                    </div>
                    <div class="form-group">
